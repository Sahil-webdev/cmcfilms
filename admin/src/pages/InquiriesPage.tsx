...
import { Search, MapPin, Calendar, Mail, Phone, X, CheckCircle, Edit, Trash2 } from 'lucide-react';
...
export const InquiriesPage: React.FC<InquiriesPageProps> = ({
  ...
  return (
    <div className="p-6 sm:p-8 space-y-6 max-w-7xl mx-auto">
      {/* Top Filter Bar */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 bg-[#121520] border border-[#202434] p-4 rounded-2xl">
        {/* Status Pills */}
                ...
                >
                  ...
                  <td className="py-4 px-5 text-right space-x-2" onClick={(e) => e.stopPropagation()}>
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-[#1A1E2C] hover:bg-[#C47A65] text-slate-300 hover:text-white transition-colors"
                    >
                      Manage
                    </button>
                  </td>
      ...
      {selectedInquiry && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#121520] border border-[#23293D] rounded-3xl max-w-lg w-full p-6 space-y-6 shadow-2xl relative">
            <button
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Wedding Date: {selectedInquiry.weddingDate}</p>
            </div>
            ...
            {/* Contact Details */}
            <div className="p-4 rounded-xl bg-[#171B29] border border-[#23293D] space-y-2 text-xs">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Enter private notes (e.g. advance payment date, lens requirements...)"
