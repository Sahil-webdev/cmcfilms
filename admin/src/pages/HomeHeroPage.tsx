...
const heroPages = [
  { key: 'home', label: 'Home', type: 'video' },
  { key: 'portfolio', label: 'Wedding Stories', type: 'image' },
  { key: 'films', label: 'Wedding Films', type: 'video' },
  { key: 'couples', label: 'Couple Shoot', type: 'image' },
  { key: 'testimonials', label: 'Testimonials', type: 'image' },
  { key: 'packages', label: 'Packages', type: 'image' },
  { key: 'about', label: 'About', type: 'image' },
] as const;
