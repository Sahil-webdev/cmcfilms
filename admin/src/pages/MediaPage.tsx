  ...
  return (
    <div className="p-6 sm:p-8 space-y-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="font-editorial text-2xl font-semibold text-slate-900 dark:text-white">Media Asset Library</h3>
        ...
        {media.map((asset) => (
          ...
          >
            ...
            <div className="p-4 space-y-3">
              <div>
                <p className="text-xs font-semibold text-slate-900 dark:text-white truncate">{asset.title}</p>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2 rounded-xl bg-slate-100 dark:bg-[#1A1E2C] hover:bg-slate-200 dark:hover:bg-[#23293D] text-xs font-semibold text-slate-700 dark:text-slate-300 transition-colors"
              >
                {copiedId === asset.id ? (
                  <>
