...
export function FeaturedStory() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative flex h-full flex-col justify-end px-5 pb-8 text-ivory md:px-12 md:pb-20 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
      ...
      >
        <div className="max-w-[1600px] w-full mx-auto">
          ...
          <p className="label-xs mt-3 md:mt-4 text-ivory/70 font-mono">
