...
import { FooterOption7 } from "./footers/FooterOption7";

/**
 * Main Footer component wrapper.
 * Currently active: Footer Option 7 (SLOPED CINEMATIC CURVE EDITION - As requested with left-low / right-rising sloppy slope).
 ...
 * - Option 6: <FooterOption6 /> (Dual-Tone Warm Ivory Top Strip with 3 Photo Windows)
 * - Option 7: <FooterOption7 /> (Sloped Cinematic Curve Edition - Low on Left, Rising UP on Right with floating photo)
 */
export function Footer() {
  return <FooterOption7 />;
}
