...
import { Instagram, Youtube, MessageCircle, Mail, MapPin, ArrowUpRight } from "lucide-react";
...
export function Footer() {
  return (
    <footer className="grain relative overflow-hidden bg-[#0A0C0E] text-ivory border-t border-white/10">
      ...
      <div className="relative mx-auto max-w-[1600px] px-5 py-12 md:px-10 md:py-16">
